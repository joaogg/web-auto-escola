                ...
                <div class="col-md-12">
                    <div class="well" style="background: #FFFFFF; border-radius: 0px;">
                        ...
                        <form name="form1" action="submit" method="POST">
                            ...
                            <div class="form-group">
                                <label>CPF:</label>
                                <input type="text" name="cpf" class="form-control" placeholder="Digite seu CPF" onkeypress='return filtroTeclas(event)'>
                            </div>
                            <div class="form-group">
                                <label>RG:</label>
                        ...
                        <a href="/WebAutoEscolaSpring/perfil"><button class="btn btn-primary">Perfil</button></a>                        
                    </div>
                </div>
            </div>
        </div>
