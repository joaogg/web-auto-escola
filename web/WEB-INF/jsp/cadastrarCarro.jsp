<%-- 
    ...
    Created on : 06/09/2018, 00:49:02
    Author     : pein2
--%>
                ...
                <div class="col-md-12">
                    <div class="well" style="background: #FFFFFF; border-radius: 0px;">
                        ...
                        <div class="alert alert-success" role="alert">
                            Sucesso ( <b>${carro.placa}</b> )!                                 
                        </div>
                        <% }%>

                        <form name="form1" action="submitCarro" method="POST">
                            <div class="form-group">
                                <label>Placa:</label>
                                <input type="text" name="placa" class="form-control" placeholder="Digite a Placa">
                            </div>
                            <div class="form-group">
                                <label>Modelo:</label>
                            ...
                            <div class="form-group">
                                <label>Ano:</label>
                                <input type="text" name="ano" class="form-control" placeholder="Digite o Ano"onkeypress='return filtroTeclas(event)'>
                            </div>
                            <div class="form-group">
                                <label>Marca:</label>
                            ...
                            <button type="submit" name="submit" class="btn btn-success" value="Cadastrar">Cadastrar</button>
                        </form>                   
                    </div>
                </div>
            </div>
