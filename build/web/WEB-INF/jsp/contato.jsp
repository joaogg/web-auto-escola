<%-- 
    Document   : contato
    Created on : 11/09/2018, 01:45:38
    Author     : pein2
--%>
            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="well" style="background: #FFFFFF; border-radius: 0px;">
                        ...
                        <form name="form1" action="submitContato" method="POST">
                            ...
                            <div class="form-group">
                                <label>Texto:</label>
                                <textarea class="form-control" rows="5" id="contato" name="contato"></textarea>
                            </div>
                            <div class="form-group">
                                <div class="g-recaptcha" data-sitekey="6Ld1lW8UAAAAACnS5G-fwudJHG8QCBp8Adwt6uVm"></div>
                            </div>
                            <button type="submit" name="submit" class="btn btn-success" value="Cadastrar">Enviar</button>
                        </form>
                        </br>
                        <a href="/WebAutoEscolaSpring/"><button class="btn btn-primary">Início</button></a>                        
                    </div>
                </div>
            </div>
        </div>
